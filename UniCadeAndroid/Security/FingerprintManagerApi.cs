...
namespace UniCadeAndroid.Security
{
    ...
    ///     Activity.
    /// </remarks>
    public class FingerprintManagerApi : DialogFragment
    {
        static readonly string TAG = "X:" + typeof (FingerprintManagerApi).Name;
        ...
        {
            FingerprintManagerApi frag = new FingerprintManagerApi
                                                       {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View v = inflater.Inflate(Resource.Layout.FingerprintScanDialog, container, false);
        ...
        class SimpleAuthCallbacks : FingerprintManagerCompat.AuthenticationCallback
        {
            ...
            readonly FingerprintManagerApi _fragment;

            public SimpleAuthCallbacks(FingerprintManagerApi frag)
            {
                _fragment = frag;
            }
